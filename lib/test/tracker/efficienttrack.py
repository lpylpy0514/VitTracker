...
from lib.models.efficientvit.efficienttrack import build_efficienttrack
...
class EfficientTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        super(EfficientTrack, self).__init__(params)
        network = build_efficienttrack(params.cfg)
    ...
    def track(self, image, info: dict = None):
        ...
        if self.save_all_boxes:
            ...
            return {"target_bbox": self.state,
                    "confidence": out_dict['score_map'].max()}
