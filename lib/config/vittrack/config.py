...
cfg.MODEL.BACKBONE.CHANNELS = 768
cfg.MODEL.BACKBONE.HEADS = 12
cfg.MODEL.BACKBONE.DEPTH = 12
cfg.MODEL.BACKBONE.PEMODE = "standard"

cfg.MODEL.NECK = edict()
cfg.MODEL.NECK.TYPE = "None"
cfg.MODEL.NECK.NUM_LAYERS = 1
cfg.MODEL.NECK.STRIDE = 1
...
cfg.TRAIN.AUX_WEIGHT = 1.0
cfg.TRAIN.AUX_TYPE = "3 output"
cfg.TRAIN.FREEZE_LAYERS = [0, ]
cfg.TRAIN.PRINT_INTERVAL = 50
cfg.TRAIN.VAL_EPOCH_INTERVAL = 20
cfg.TRAIN.GRAD_CLIP_NORM = 0.1
cfg.TRAIN.AMP = False
cfg.TRAIN.TEACHER = "ostrack"
...
cfg.DATA.TEMPLATE.PREPROCESS = 'None'
